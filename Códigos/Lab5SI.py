...
def joint_publisher():
    ...
    while True:
        ...
        #Casos de trabajo
        if tarea==1:
            img1BGR= cv2.imread('/home/danilo/catkin_ws/src/dynamixel_one_motor/scripts/Imagenes/circmax.jpg')
            ...
            img1BGR= cv2.imread('/home/danilo/catkin_ws/src/dynamixel_one_motor/scripts/Imagenes/circmin.jpg')
            img1RGB=cv2.cvtColor(img1BGR, cv2.COLOR_BGR2RGB)
            plt.imshow(img1RGB)
            plt.show()
            start_time = time.time()
            ...
            img1BGR= cv2.imread('/home/danilo/catkin_ws/src/dynamixel_one_motor/scripts/Imagenes/dn.jpg')
            img1RGB=cv2.cvtColor(img1BGR, cv2.COLOR_BGR2RGB)
            plt.imshow(img1RGB)
            plt.show()
            start_time = time.time()
            ...
            img1BGR= cv2.imread('/home/danilo/catkin_ws/src/dynamixel_one_motor/scripts/Imagenes/circulo.jpg')
            img1RGB=cv2.cvtColor(img1BGR, cv2.COLOR_BGR2RGB)
            plt.imshow(img1RGB)
            plt.show()
            start_time = time.time()
            ...
            img1BGR= cv2.imread('/home/danilo/catkin_ws/src/dynamixel_one_motor/scripts/Imagenes/x.jpg')
            img1RGB=cv2.cvtColor(img1BGR, cv2.COLOR_BGR2RGB)
            plt.imshow(img1RGB)
            plt.show()
            start_time = time.time()
